...
def getDataFor10Folds(fpInputSubmission, fopAST,fopText, fpOutputVectorDistance, fpOutputVectorTFIDF):
...
def main():
    ...
    fpStudentDistance = fopInput + "vectorCombine_Distance_folds.csv"
    fpStudentTFIDF = fopInput + "vectorCombine_TFIDF_folds.csv"
    getDataFor10Folds(fpStudentSubmission,fopAST, fopText,fpStudentDistance, fpStudentTFIDF)
