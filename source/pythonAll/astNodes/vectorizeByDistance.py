...
def main():
    ...
    fopText = "/home/hung/git/dataLocal/hw2TextualTree/"
    fpStudentSubmission=fopInput+"StudentScore - ReviseList.csv"
    fpStudentDistance = fopInput + "vectorAST_Distance_folds.csv"
    fpStudentTFIDF = fopInput + "vectorAST_TFIDF_folds.csv"
